...
describe("unified viewer UI", () => {
  ...
  test("file manager 2.0 ships compact page wired into dashboard2", async () => {
    ...
    expect(html).toContain("fm2-selectall");
    expect(html).toContain("fm2-delbar");
    expect(html).toContain("fm2-kb-blocks");
    expect(html).toContain("fm2-kb-pac");
    expect(html).toContain("fm2-summary");
    ...
    expect(js).toContain('"1.2.1"');
    expect(js).toContain("selectAllVisible");
    expect(js).toContain("runDeleteBatch");
    expect(js).toContain("deleteBatchActive");
    expect(js).toContain("classifyDeleteFailure");
    expect(js).toContain("abortDeleteBatch");
    expect(js).toContain("pendingPostList");
    expect(js).toContain("showContextMenu");
    expect(js).toContain("executeFileOnTarget");
    expect(js).toContain("file_execute");
    expect(js).toContain("fm2-ctx");
    expect(html).toContain("#fm2-ctx");
